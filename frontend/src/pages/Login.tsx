...
export default function Login() {
    ...
    return (
        <main className="relative min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-black flex items-center justify-center p-4">
            <div className="relative w-full max-w-md p-8 bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 shadow-2xl max-h-[90vh] overflow-y-auto">
                {/* Back to Home Link */}
                <div className="mb-4">
                    <Link
                        to="/"
